...
#[cfg_attr(
    target_os = "android",
    ndk_glue::main(backtrace = "on", logger(level = "debug", tag = "vk_tutorial_rs"))
)]
pub fn main() {
    ...
    #[cfg(not(target_os = "android"))]
    let mut app = Some(VulkanApp::new(&window));
    #[cfg(target_os = "android")]
    let mut app: Option<VulkanApp> = None;
        ...
        *control_flow = ControlFlow::Poll;
        ...
        match event {
            ...
            Event::Resumed => {
                ...
                if app.is_none() {
                    app.replace(VulkanApp::new(&window));
                }
            }
